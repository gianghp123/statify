      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-border gap-4 pb-0">
          <div className="flex gap-1 overflow-x-auto w-full md:w-auto no-scrollbar">
            <div className="relative flex flex-col items-center justify-center px-4 py-3 text-foreground group cursor-pointer">
            ...
            <div className="relative flex flex-col items-center justify-center px-4 py-3 text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
          ...
          <div className="w-full md:w-96 pb-2 md:pb-2">
            <div className="relative group">
              ...
              <Input
                className="block w-full rounded-lg bg-card border-border text-foreground placeholder:text-muted-foreground/50 focus:border-primary focus:ring-1 focus:ring-primary sm:text-sm pl-10 py-2.5 shadow-sm transition-all"
