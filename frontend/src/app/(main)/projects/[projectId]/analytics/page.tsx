      ...
      <div className="glass-card rounded-xl p-6 border border-border shadow-xl space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <h3 className="text-foreground text-lg font-bold">Traffic Overview</h3>
            <div className="flex bg-background/50 rounded-lg p-1 border border-border">
              ...
              <button className="px-3 py-1 rounded text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors">Bandwidth</button>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <div className="flex bg-background/50 rounded-lg p-1 border border-border">
              <button className="px-3 py-1 rounded text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors">1D</button>
              <button className="px-3 py-1 rounded text-xs font-bold bg-primary/20 text-primary border border-primary/50">1W</button>
              <button className="px-3 py-1 rounded text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-white/5 transition-colors">1M</button>
            </div>
